...
(function() {
  ...
  module.exports = Client = (function(superClass) {
    ...
    Client.prototype.doInit = function() {
      ...
      this.channel = new Channel(this.jarstore);
      this.init = new Init();
      return this.chatreq = new ChatReq(this.jarstore, this.init, this.channel);
    };
